...
class Clock {
   public:
    Clock(int cols) : m_cols(cols), m_tempo(120.0f), m_steps(16), m_currentStep(0), running(true) {
        changeTempo(m_tempo);
    }
...
// I presume you have a main function somewhere to initialize and use the Clock class, like:
// int main() {
